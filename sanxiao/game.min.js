...
this._map[a.y][a.x];this._map[a.y][a.x]=this._map[b.y][b.x];this._map[b.y][b.x]=c}},debugLog:function(){var a=this._map;cc.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");for(var b=0;b<this._map.length;b++){for(var c="[ ",d=0;d<this._map[0].length;d++)c=c+a[b][d]+" , ";console.log(c+"],")}}};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(640,1136,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new HelloWorldScene)},this)};cc.game.run();