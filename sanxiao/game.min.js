...
(cc._renderType=cc.game.RENDER_TYPE_WEBGL,cc._supportRender=!0)}function b(a,c,d){if(h[c])return null;d=d||"";var e=[],f=a[c];if(!f)throw Error("can not find module ["+c+"]");c=cc.path;for(var g=0,m=f.length;g<m;g++){var k=f[g];if(!h[k]){var v=c.extname(k);v?".js"===v.toLowerCase()&&e.push(c.join(d,k)):(v=b(a,k,d))&&(e=e.concat(v));h[k]=1}}return e}function c(a){cc._initDebugSetting&&cc._initDebugSetting(a[cc.game.CONFIG_KEY.debugMode]);cc._engineLoaded=!0;cc.log(cc.ENGINE_VERSION);m&&m()}function d(a){var d=
a[cc.game.CONFIG_KEY.engineDir],e=cc.loader;if(cc.Class)c(a);else{var f=cc.path.join(d,"moduleConfig.json");e.loadJson(f,function(e,f){if(e)throw Error(e);var g=a.modules||[],h=f.module,m=[];cc.sys.capabilities.opengl&&0>g.indexOf("base4webgl")?g.splice(0,0,"base4webgl"):0>g.indexOf("core")&&g.splice(0,0,"core");for(var k=0,r=g.length;k<r;k++){var s=b(h,g[k],d);s&&(m=m.concat(s))}cc.loader.loadJsWithImg(m,function(b){if(b)throw b;c(a)})})}}function e(){this.removeEventListener("load",e,!1);d(cc.game.config)}
...
"miuibrowser";a.BROWSER_TYPE_FIREFOX="firefox";a.BROWSER_TYPE_SAFARI="safari";a.BROWSER_TYPE_CHROME="chrome";a.BROWSER_TYPE_LIEBAO="liebao";a.BROWSER_TYPE_QZONE="qzone";a.BROWSER_TYPE_SOUGOU="sogou";a.BROWSER_TYPE_UNKNOWN="unknown";a.isNative=!1;var b=window,c=b.navigator,d=document,e=d.documentElement,h=c.userAgent.toLowerCase();a.isMobile=-1!==h.indexOf("mobile")||-1!==h.indexOf("android");a.platform=a.isMobile?a.MOBILE_BROWSER:a.DESKTOP_BROWSER;var m=c.language,m=(m=m?m:c.browserLanguage)?m.split("-")[0]:
a.LANGUAGE_ENGLISH;a.language=m;var k=m=!1,v="",y=0,x=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);x&&(m=!0,v=x[1]||"",y=parseInt(v)||0);if(x=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))k=!0,v=x[2]||"",y=parseInt(v)||0;x=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?x=a.OS_WINDOWS:k?x=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?x=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?x=a.OS_UNIX:m?x=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&
(x=a.OS_LINUX);a.os=x;a.osVersion=v;a.osMainVersion=y;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:
"360 aphone"===b?b=a.BROWSER_TYPE_360:"mxbrowser"===b?b=a.BROWSER_TYPE_MAXTHON:"opr"===b&&(b=a.BROWSER_TYPE_OPERA);a.browserType=b})();a.browserVersion="";(function(){var b=/(msie |rv:|firefox|chrome|ucbrowser|oupeng|opera|opr|safari|miui)(mobile)?(browser)?\/?([\d.]+)/i,c=h.match(/(micromessenger|qq|mx|maxthon|baidu|sogou)(mobile)?(browser)?\/?([\d.]+)/i);c||(c=h.match(b));a.browserVersion=c?c[4]:""})();m=window.devicePixelRatio||1;a.windowPixelResolution={width:m*(window.innerWidth||document.documentElement.clientWidth),
...
a.getImageData(0,0,1,1).data[0]}();cc.sys.isMobile&&(m=document.createElement("style"),m.type="text/css",document.body.appendChild(m),m.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var w=a.localStorage=b.localStorage;w.setItem("storage","");w.removeItem("storage");w=null}catch(C){w=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},
a.localStorage={getItem:w,setItem:w,removeItem:w,clear:w}}w=!!f.getContext("2d");m=!1;if(b.WebGLRenderingContext){k=document.createElement("CANVAS");try{if(cc.create3DContext(k,{stencil:!0,preserveDrawingBuffer:!0})&&(m=!0),m&&a.os===a.OS_ANDROID){var A=parseFloat(a.browserVersion);switch(a.browserType){case a.BROWSER_TYPE_MOBILE_QQ:case a.BROWSER_TYPE_BAIDU:case a.BROWSER_TYPE_BAIDU_APP:m=6.2<=A?!0:!1;break;case a.BROWSER_TYPE_CHROME:m=30<=A?!0:!1;break;case a.BROWSER_TYPE_ANDROID:a.osMainVersion&&
5<=a.osMainVersion&&(m=!0);break;case a.BROWSER_TYPE_UNKNOWN:case a.BROWSER_TYPE_360:case a.BROWSER_TYPE_MIUI:m=!1}}}catch(D){}k=null}A=a.capabilities={canvas:w,opengl:m};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)A.touches=!0;void 0!==e.onmouseup&&(A.mouse=!0);void 0!==e.onkeyup&&(A.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)A.accelerometer=!0;a.garbageCollect=function(){};a.dumpRoot=function(){};a.restartVM=function(){};a.cleanScript=function(a){};
...
a[2]=n;a[3]=s;a[4]=b;a[6]=p;a[7]=u;a[8]=c;a[9]=k;a[11]=t;a[12]=d;a[13]=m;a[14]=r;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],r=k[4],s=k[5],u=k[6],t=k[7],z=k[8],B=k[9],v=k[10],y=k[11],x=k[12],w=k[13],C=k[14],k=k[15],A=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=A*c+D*r+E*z+F*x;d[1]=A*b+D*s+E*B+F*w;d[2]=A*n+D*u+E*v+F*C;d[3]=A*p+D*t+E*y+F*k;d[4]=G*c+H*r+I*z+J*x;d[5]=
G*b+H*s+I*B+J*w;d[6]=G*n+H*u+I*v+J*C;d[7]=G*p+H*t+I*y+J*k;d[8]=K*c+L*r+M*z+N*x;d[9]=K*b+L*s+M*B+N*w;d[10]=K*n+L*u+M*v+N*C;d[11]=K*p+L*t+M*y+N*k;d[12]=O*c+P*r+Q*z+m*x;d[13]=O*b+P*s+Q*B+m*w;d[14]=O*n+P*u+Q*v+m*C;d[15]=O*p+P*t+Q*y+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],r=b[6],s=b[7],u=b[8],t=b[9],z=b[10],B=b[11],v=b[12],y=b[13],x=b[14],w=b[15],C=c[0],A=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=C*a+A*n+D*u+E*v;b[1]=C*d+A*p+D*t+E*y;b[2]=C*k+A*r+D*z+E*x;b[3]=C*m+A*s+D*B+E*w;b[4]=F*a+G*n+H*u+I*v;b[5]=F*d+G*p+H*t+I*y;b[6]=F*k+G*r+H*z+I*x;b[7]=F*m+G*s+H*B+I*w;b[8]=J*a+K*n+L*u+M*v;b[9]=J*d+K*p+L*t+M*y;b[10]=J*k+K*r+L*z+M*x;b[11]=J*m+K*s+L*B+M*w;b[12]=N*a+O*n+P*u+c*v;b[13]=N*d+O*p+P*t+c*y;b[14]=N*k+O*r+P*z+c*x;b[15]=N*m+O*s+P*B+c*w;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
a);this.delta=this.to-this.from},update:function(a){this.target.updateTweenAction(this.to-this.delta*(1-a),this.key)},reverse:function(){return new cc.ActionTween(this.duration,this.key,this.to,this.from)},clone:function(){var a=new cc.ActionTween;a.initWithDuration(this._duration,this.key,this.from,this.to);return a}});cc.actionTween=function(a,b,c,d){return new cc.ActionTween(a,b,c,d)};cc.ActionTween.create=cc.actionTween;var res={HelloWorld_png:"res/HelloWorld.png",cube_png1:"res/cube1.png",cube_png2:"res/cube2.png",cube_png3:"res/cube3.png",cube_png4:"res/cube4.png",cube_png5:"res/cube5.png",cube_png6:"res/cube6.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var HelloWorldLayer=cc.Layer.extend({sprite:null,mapSize:null,cubeSize:null,mapOriginP:null,touchBeganP:null,cubeArry:[],cubeMoveV:450,swapCubeT:0.4,ctor:function(){this._super();this.initData();this.initUI();this.addTouchListener();return!0},initUI:function(){EliminateHelper.createRandMap();for(var a=0;a<this.mapSize.height;a++)for(var b=0;b<this.mapSize.width;b++){var c=this.createCubeSp(Map[a][b]);c.setPositionX(this.mapOriginP.x+b*this.cubeSize.width);c.setPositionY(this.mapOriginP.y-a*this.cubeSize.height);
this.addChild(c);0==Map[a][b]&&c.setVisible(!1);this.cubeArry.push(c)}},initData:function(){this.cubeSize=cc.size(71,71);this.mapSize=cc.size(Map[0].length,Map.length);var a=cc.p(cc.winSize.width/2,cc.winSize.height/2),b=cc.p(0,0);0==this.mapSize.width%2&&(b.x=0.5);0==this.mapSize.height%2&&(b.y=0.5);this.mapOriginP=cc.p(a.x-(this.mapSize.width/2-b.x)*this.cubeSize.width,a.y+(this.mapSize.height/2-b.y)*this.cubeSize.height)},getCubeLogicP:function(a){var b=cc.p(this.mapOriginP.x-this.cubeSize.width/
2,this.mapOriginP.y+this.cubeSize.height/2),c=a.x-b.x;a=b.y-a.y;c=Math.floor(c/this.cubeSize.width);a=Math.floor(a/this.cubeSize.height);console.log("dpx "+c+" dpy "+a);return 0>c||0>a||c>=this.mapSize.width||a>=this.mapSize.height?null:cc.p(c,a)},addTouchListener:function(){cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan,onTouchMoved:this.onTouchMoved,onTouchEnded:this.onTouchEnded,onTouchCancelled:this.onTouchCancelled},this)},
onTouchBegan:function(a,b){cc.log("onTouchBegan");b.getCurrentTarget().touchBeganP=a.getLocation();return!0},onTouchMoved:function(a,b){b.getCurrentTarget();a.getLocation()},onTouchEnded:function(a,b){var c=b.getCurrentTarget(),d=a.getLocation();c.touchBeganP&&(Math.abs(c.touchBeganP.x-d.x)>=c.cubeSize.width/2||Math.abs(c.touchBeganP.y-d.y)>=c.cubeSize.height/2)&&c.dealSwapCube(d)},onTouchCancelled:function(a,b){b.getCurrentTarget()},dealSwapCube:function(a){var b=this.touchBeganP;if(b){var c=this.getCubeLogicP(b);
if(c){var d=a.x-b.x;a=a.y-b.y;b=null;b=Math.abs(d)>Math.abs(a)?0<d?cc.p(1,0):cc.p(-1,0):0<a?cc.p(0,-1):cc.p(0,1);d=cc.p(c.x+b.x,c.y+b.y);console.log("logicPx "+c.x+" logicPy "+c.y);console.log("swapPx "+d.x+" swapPy "+d.y);d&&EliminateHelper.isEnableP(d)&&this.swapCube(c,d)}}},swapCube:function(a,b){EliminateHelper.swapCube(a,b);if(EliminateHelper.isEliminate(b)){var c=this.getCubeSpByP(a),d=this.getCubeSpByP(b),e=this.getScreenP(a),f=this.getScreenP(b);c.stopAllActions();d.stopAllActions();c.runAction(cc.moveTo(this.swapCubeT,
f));d.runAction(cc.sequence(cc.moveTo(this.swapCubeT,e),cc.callFunc(function(){this.eliminateCube(a);this.eliminateCube(b)},this)));this.swapCubeObject(a,b)}else console.log("no eliminate"),EliminateHelper.swapCube(a,b)},getMoveTime:function(a,b){var c=this.getScreenP(a),d=this.getScreenP(b);return this.getMoveTimeBS(c,d)},getMoveTimeBS:function(a,b){return Math.abs((a.y-b.y)/this.cubeMoveV)},getCubeSpByP:function(a){return this.cubeArry[a.x+a.y*this.mapSize.width]},setCubeSpByP:function(a,b){this.cubeArry[a.x+
a.y*this.mapSize.width]=b},getScreenP:function(a){return cc.p(this.mapOriginP.x+a.x*this.cubeSize.width,this.mapOriginP.y-a.y*this.cubeSize.height)},swapCubeObject:function(a,b){var c=this.getCubeSpByP(a),d=this.getCubeSpByP(b);this.setCubeSpByP(a,d);this.setCubeSpByP(b,c)},eliminateCube:function(a){var b=EliminateHelper.getElArry(a);if(!(3>b.length)){for(a=0;a<b.length;a++){var c=this.getCubeSpByP(b[a]);c.setVisible(!1);c.removeFromParent()}var d=EliminateHelper.moveDownCube();if(3<=b.length&&0==
d.length)this.createDownCube();else for(a=0;a<d.length;a++)b=d[a],c=this.getCubeSpByP(b.beganP),c.stopAllActions(),c.setPosition(this.getScreenP(b.beganP)),this.swapCubeObject(b.beganP,b.endP),c.runAction(cc.sequence(cc.moveTo(this.getMoveTime(b.beganP,b.endP),this.getScreenP(b.endP)),cc.callFunc(function(a,b){this.createDownCube();this.eliminateCube(b)},this,b.endP)))}},createDownCube:function(){for(var a=EliminateHelper.createDownCube(),b=0;b<a.length;b++)for(var c=a[b],d=0;d<c.length;d++){var e=
c[d],f=this.createCubeSp(Map[e.y][e.x]);this.setCubeSpByP(e,f);this.addChild(f);var g=this.getScreenP(e),h=cc.p(g.x,this.mapOriginP.y+(c.length-e.y)*this.cubeSize.height);f.setPosition(h);g=cc.moveTo(this.getMoveTimeBS(g,h),g);f.stopAllActions();f.runAction(cc.sequence(g,cc.callFunc(function(a,b){this.createDownCube();this.eliminateCube(b)},this,e)))}},createCubeSp:function(a){var b=new cc.Sprite(res["cube_png"+a]);a=cc.LabelTTF.create(""+a,"Arial",40);a.setColor(cc.color(0,0,0));a.setPosition(cc.p(this.cubeSize.width/
2,this.cubeSize.height/2));b.addChild(a);return b}}),HelloWorldScene=cc.Scene.extend({onEnter:function(){this._super();var a=new HelloWorldLayer;this.addChild(a)}});var Map=[[6,1,4,4,3,2,5,5],[5,5,1,2,6,2,2,3],[6,4,2,1,2,6,4,2],[1,1,4,1,6,6,2,4],[6,2,3,4,1,4,2,6],[6,1,4,3,4,1,4,3],[3,1,3,4,1,6,2,4],[6,5,1,1,5,4,6,1]];var EliminateHelper={_cArry:[],_disableP:{i:-1,j:-1},_replaceP:{i:-1,j:-1},_directionP:[{di:-1,dj:0},{di:1,dj:0},{di:0,dj:1},{di:0,dj:-1}],_directionDP:[[{di:0,dj:-1},{di:0,dj:-2}],[{di:0,dj:1},{di:0,dj:2}],[{di:-1,dj:0},{di:-2,dj:0}],[{di:1,dj:0},{di:2,dj:0}]],_map:Map,_disablePointV:[],_disableValueV:[0],_ignorePoint:cc.p(-1,-1),_emptyType:0,_reData:function(){this._cArry=[];this._disablePointV=[];this._disableValueV=[0]},getElArry:function(a){var b=a.x,c=a.y,d=[],e=this._map[c][b];if(this._emptyType==
e)return d;a=this._isEliminateType(a);if(0<a.length){d.push(cc.p(b,c));for(var f=0;f<a.length;f++){var g=a[f],h=cc.p(b+g.x,c+g.y);this._searchEArry(h,g,e,d)}}this.setMapEmptyCube(d);return d},createDownCube:function(){for(var a=this._map,b=[],c=0;c<a[0].length;c++){for(var d=[],e=a.length-1;0<=e;e--)a[e][c]==this._emptyType&&(a[e][c]=this.getRandNum(1,6),d.push(cc.p(c,e)));b.push(d)}return b},moveDownCube:function(){for(var a=this._map,b=[],c=0;c<a[0].length;c++)for(var d=a.length-1;0<=d;d--)if(a[d][c]==
this._emptyType){var e=this._searchDownCube(cc.p(c,d));e&&b.push(e)}return b},_searchDownCube:function(a){for(var b=this._map,c=null,d=a;;){d=cc.p(d.x,d.y-1);if(!this._checkP(d))break;if(b[d.y][d.x]!=this._emptyType){c={beganP:d,endP:a};this._swapPValue(d,a);break}}return c},setMapEmptyCube:function(a){for(var b=0;b<a.length;b++){var c=a[b];this._map[c.y][c.x]=this._emptyType}},_searchEArry:function(a,b,c,d){this._checkP(a)&&c==this._map[a.y][a.x]&&(d.push(a),a=cc.p(a.x+b.x,a.y+b.y),this._searchEArry(a,
b,c,d))},haveEliminate:function(){for(var a=this._map,b=0;b<a.length;b++)for(var c=0;c<a[0].length;c++)if(!this._checkDisableValue(cc.p(c,b))&&this._moveSearch(b,c))return!0;return!1},_moveSearch:function(a,b){console.log("i "+a+" j "+b);for(var c=cc.p(b,a),d=0;d<this._directionP.length;d++){var e=this._directionP[d],e=cc.p(b+e.dj,a+e.di);if(this._checkP(e)){this._swapPValue(e,c);var f=this.isEliminate(e);this._swapPValue(e,c);if(f)return!0}}return!1},isEliminate:function(a){return 0<this._isEliminateType(a).length?
!0:!1},_isEliminateType:function(a){var b=a.x;a=a.y;var c=cc.p(b,a),d=[],e=0,f=cc.p(c.x-1,c.y),g=cc.p(c.x+1,c.y);this._checkP(f)&&this._checkP(g)&&this._compareMapValue(c,f)&&this._compareMapValue(c,g)&&(this.pushArryUnique(d,cc.p(-1,0)),this.pushArryUnique(d,cc.p(1,0)),e=2);f=cc.p(c.x,c.y-1);g=cc.p(c.x,c.y+1);this._checkP(f)&&this._checkP(g)&&this._compareMapValue(c,f)&&this._compareMapValue(c,g)&&(this.pushArryUnique(d,cc.p(0,1)),this.pushArryUnique(d,cc.p(0,-1)),e=this._directionDP.length);for(;e<
this._directionDP.length;e++){var f=this._directionDP[e],g=cc.p(f[0].dj+b,f[0].di+a),h=cc.p(f[1].dj+b,f[1].di+a);this._checkP(g)&&this._checkP(h)&&this._compareMapValue(c,g)&&this._compareMapValue(c,h)&&this.pushArryUnique(d,cc.p(f[0].dj,f[0].di))}return d},pushArryUnique:function(a,b){for(var c=0;c<a.length;c++)if(this._compareP(a[c],b))return;a.push(b)},_swapPValue:function(a,b){var c=this._map,d=c[a.y][a.x];c[a.y][a.x]=c[b.y][b.x];c[b.y][b.x]=d},_compareP:function(a,b){return a.x==b.x&&a.y==b.y?
!0:!1},_compareMapValue:function(a,b){var c=this._map;return c[a.y][a.x]==c[b.y][b.x]?!0:!1},isEnableP:function(a){return this._map[a.y][a.x]==this._emptyType?!1:this._checkP(a)},_checkP:function(a){var b=a.y;a=a.x;return 0>b||b>=this._map.length||0>a||a>=this._map[0].length?!1:!0},_checkDisablePoint:function(a){for(var b=0;b<this._disablePointV.length;b++)if(this._compareP(this._disablePointV[b],a))return!0;return!1},_checkDisableValue:function(a){for(var b=0;b<this._disableValueV.length;b++)if(this._map[a.y][a.x]==
this._disableValueV[b])return!0;return!1},createRandMap:function(){this.clearMap();for(var a=0;a<this._map.length;a++)for(var b=0;b<this._map[0].length;b++)for(;;){var c=this.getRandNum(1,6);this._map[a][b]=c;if(!this.isEliminate(cc.p(b,a)))break}},clearMap:function(){for(var a=0;a<this._map.length;a++)for(var b=0;b<this._map[0].length;b++)this._map[a][b]=0},getRandNum:function(a,b){var c=Math.random()*b+a;return Math.floor(c)},swapCube:function(a,b){if(this.isEnableP(a)&&this.isEnableP(b)){var c=
this._map[a.y][a.x];this._map[a.y][a.x]=this._map[b.y][b.x];this._map[b.y][b.x]=c}},debugLog:function(){var a=this._map;cc.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");for(var b=0;b<this._map.length;b++){for(var c="[ ",d=0;d<this._map[0].length;d++)c=c+a[b][d]+" , ";console.log(c+"],")}}};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(!0);cc.view.adjustViewPort(!0);cc.view.enableAutoFullScreen(!0);cc.view.setDesignResolutionSize(640,1136,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new HelloWorldScene)},this)};cc.game.run();